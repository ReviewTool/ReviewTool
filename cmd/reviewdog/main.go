...
import (
	...
	"github.com/reviewtool/reviewtool/commands"
	"github.com/reviewtool/reviewtool/filter"
	"github.com/reviewtool/reviewtool/parser"
	"github.com/reviewtool/reviewtool/project"
	bbservice "github.com/reviewtool/reviewtool/service/bitbucket"
	gerritservice "github.com/reviewtool/reviewtool/service/gerrit"
	githubservice "github.com/reviewtool/reviewtool/service/github"
	"github.com/reviewtool/reviewtool/service/github/githubutils"
	gitlabservice "github.com/reviewtool/reviewtool/service/gitlab"
)
...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "See https://github.com/reviewtool/reviewtool for more detail.")
	os.Exit(2)
}
...
func runList(w io.Writer) error {
	...
	fmt.Fprintf(tabw, "%s\t%s\t- %s\n", "rdjson", "Reviewdog Diagnostic JSON Format (JSON of DiagnosticResult message)", "https://github.com/reviewtool/reviewtool")
	fmt.Fprintf(tabw, "%s\t%s\t- %s\n", "rdjsonl", "Reviewdog Diagnostic JSONL Format (JSONL of Diagnostic message)", "https://github.com/reviewtool/reviewtool")
