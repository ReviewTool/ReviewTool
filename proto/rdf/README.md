...
much welcome. Please leave comments in Pull Request ([#629](https://github.com/reviewtool/reviewtool/pull/629)),
in issue [#628](https://github.com/reviewtool/reviewtool/issues/628) or
file [an issue](https://github.com/reviewtool/reviewtool/issues).

The document and the actual definition are currently under the
https://github.com/reviewtool/reviewtool repository, but we may create a separate
...
[reviewdog](https://github.com/reviewtool/reviewtool) resolves the above problem
